package com.nekotune.minecraftjourneys.shared.definitions.item.armor;
...
public class MJArmorMaterials {
    ...
    public static final Holder<ArmorMaterial> CLOTH = define(
    ...
    private static Holder<ArmorMaterial> define(String name, Supplier<ArmorMaterial> material) {
