package com.nekotune.minecraftjourneys.shared.definition.loot;

import java.util.Optional;

import com.mojang.serialization.MapCodec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import com.nekotune.minecraftjourneys.shared.registry.content.MJLootItemConditions;
...
public record MatchBlock(Optional<BlockPredicate> predicate) implements LootItemCondition {
    ...
    public LootItemConditionType getType() {
        return MJLootItemConditions.MATCH_BLOCK.get();
    }
