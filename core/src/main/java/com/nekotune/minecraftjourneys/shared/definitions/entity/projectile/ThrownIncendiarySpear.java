package com.nekotune.minecraftjourneys.shared.definitions.entity.projectile;
...
public class ThrownIncendiarySpear extends ThrownSpear {
    ...
    public ThrownIncendiarySpear(float throwDamage, Level level, double x, double y, double z,
        ...
        super(throwDamage, level, x, y, z,
                pickupItemStack.transmuteCopy(MJItems.WOODEN_SPEAR.get()));
    ...
    protected ItemStack getPickupItem() {
        ...
        return this.isOnFire()
            ? stack.transmuteCopy(MJItems.INCENDIARY_SPEAR.get())
            : stack.transmuteCopy(MJItems.WOODEN_SPEAR.get());
    }
}
